...
Hi there!
Thanks for taking an interest in improving phac-nml/submitdatairidanext.

This page describes the recommended nf-core way to contribute to both phac-nml/submitdatairidanext and nf-core pipelines in general, including:
...
- [ ] Check whether a GitHub [issue](https://github.com/phac-nml/submitdatairidanext/issues) about your idea already exists. If an issue does not exist, create one so that others are aware you are working on it.
- [ ] [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [phac-nml/submitdatairidanext repository](https://github.com/phac-nml/submitdatairidanext) to your GitHub account.
...
You can contribute to phac-nml/submitdatairidanext without installing a local development environment on your machine by using [GitHub Codespaces](https://github.com/codespaces).
...
To get started, open the repository in [Codespaces](https://github.com/phac-nml/submitdatairidanext/codespaces).
...
<!-- TODO: Add any pipeline specific contribution guidelines here, such as coding styles, procedures, checklists etc. -->
